...
Maze.prototype.getShortestRoutes = function(destination) {
    ...
    var continuePathFrom = function(cell, currentRoute) {
        ...
        if(crawlableAdjacents.length > 0) {
            ...
            // N'est pas cens� arriver (sinon adjacentNode.distance > cellNode.distance)
...
// Trouve toutes les routes. Oblig� d'imposer une limite sinon ca peut durer tres longtemps
